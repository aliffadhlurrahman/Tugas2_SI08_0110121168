...
def Pendaftaran_Anggota_Baru(Kode, Nama, Tipe_Keanggotaan): ### Fungsi untuk pendaftaran anggota ###
...
def cek_buku(kd_buku): ### Fungsi untuk memeriksa apakah kode buku yang dimasukkan sudah benar/belum ###
    for i in readBuku(): ### Memanggil data buku terlebih dahulu ###
...
def cek_stok(kd_buku): ### Fungsi untuk memeriksa stok buku ###
    dataBuku = readBuku()
